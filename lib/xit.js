exports.book = require( 'singleton' ).get();
...
exports.start = function () {
	this.book.records = { };
	this.book.add = function (xact) {
		// No checking here.
		//
		this.records[xact.serial] = xact;
	}
	this.book.get = function (serial) {
...
exports.add_xact = function (xact) { // {{{
	var x = this.book.get( xact.serial );
